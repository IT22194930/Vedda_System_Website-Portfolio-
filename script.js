...
const SEARCH_INDEX = [
  ...
  // ── Documents ──
  { icon: '📋', title: 'Project Charter', desc: 'Project scope, objectives, team responsibilities, initial research direction', page: 'documents', pageLabel: 'Documents', action: () => navigateTo('documents'), href: 'https://mysliit-my.sharepoint.com/:b:/g/personal/it22194930_my_sliit_lk/IQDdKUgDRLmASYuztCjbaf2WAZSee9U8H8qqxOggkfzkGiI?e=vW5XIs' },
  { icon: '📝', title: 'Proposal Document', desc: 'Full research proposal, problem statement, literature survey, objectives, methodology, commercialization plan', page: 'documents', pageLabel: 'Documents', action: () => navigateTo('documents'), href: 'https://mysliit.sharepoint.com/:f:/s/CDAPSubmissionCloud/IgAutoUvB6djRa7PsIwSArp7ATC6iIoGn4qRyrza_RiOQK8?e=NmYy5r' },
  { icon: '📊', title: 'Check List Documents', desc: 'Formal assessment checklists submitted across project milestones', page: 'documents', pageLabel: 'Documents', action: () => navigateTo('documents'), href: 'https://mysliit.sharepoint.com/:f:/s/CDAPSubmissionCloud/IgBT4ReFwiHLT7Jrnws8zaiMAYxmsRUJv-e6laOTcVAv91M?e=3ti0dw' },
  { icon: '📕', title: 'Final Report', desc: 'Complete final documentation, individual and group reports, research paper, logbook, supporting materials', page: 'documents', pageLabel: 'Documents', action: () => navigateTo('documents'), href: 'https://mysliit.sharepoint.com/:f:/s/CDAPSubmissionCloud/IgBFr-aT6BGaQ7PTnr-s2JTkAQduKCwKBykzaAK5kyy8ZPk?e=kNXOze' },

  // ── Slides ──
  { icon: '🖥️', title: 'Proposal Presentation', desc: 'PPTX slides · Initial project proposal presentation', page: 'slides', pageLabel: 'Slides', action: () => navigateTo('slides'), href: 'https://mysliit.sharepoint.com/:p:/s/CDAPSubmissionCloud/IQAvHfE3RtiAT5iyNCZJ_EAsAZI2clgblubudiETveoiATo?e=VYhhys' },
  { icon: '🖥️', title: 'Progress Presentation 1', desc: 'PPTX slides · First progress review presentation', page: 'slides', pageLabel: 'Slides', action: () => navigateTo('slides'), href: 'https://mysliit.sharepoint.com/:p:/s/CDAPSubmissionCloud/IQA0O7ek1x4lRZBYQv2MhIn9Ad83M2JaWurXVPGDsc03g_A?e=QnZ1Ss' },
  { icon: '🖥️', title: 'Progress Presentation 2', desc: 'PPTX slides · Second progress review presentation', page: 'slides', pageLabel: 'Slides', action: () => navigateTo('slides'), href: 'https://mysliit.sharepoint.com/:p:/s/CDAPSubmissionCloud/IQCAFbXDHEH0SLvrQWAm6wt6AYI0YEY82fdFYnIp_AwDfjg?e=adHWCf' },
  { icon: '🖥️', title: 'Final Presentation', desc: 'PPTX slides · Final assessment presentation', page: 'slides', pageLabel: 'Slides', action: () => navigateTo('slides'), href: 'https://mysliit.sharepoint.com/:f:/s/CDAPSubmissionCloud/IgBU-OVtG60ETYCS5BGELfr9Aa6cC4VNMAlXWBLt6B5gmCY?e=EFCIEC' },
